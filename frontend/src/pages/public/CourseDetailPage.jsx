...
export default function CourseDetailPage() {
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-12 sm:py-16">
      ...
      {/* Key stats – 3 columns now (no Mode) */}
      ...
      <div className="mt-10">
        ...
        <p className="mt-1 text-sm text-slate-600">
          Choose an intake below to apply. You can only apply to intakes that are
          open.
        </p>

        {intakes.length === 0 ? (
          <p className="mt-4 text-sm text-slate-500">
            No intakes are currently scheduled for this course.
          </p>
        ) : (
                ...
                >
                  <div>
                    ...
                    <p className="mt-2 text-xs text-slate-500">
                      Register by {formatDate(intake.registrationDeadline)}{" "}
                      &middot; {formatFee(intake.fee)}
                    </p>
                  </div>
